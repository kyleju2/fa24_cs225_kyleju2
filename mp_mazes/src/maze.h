...
/*
  class MazeNode implementation declared in this file below:
*/
class MazeNode {
  public:
...
public:
  ...
  private:
    int height;
    int width;
    std::vector<MazeNode> maze; // maze structure storage
    DisjointSets *connections; // disjoint set to store solution
